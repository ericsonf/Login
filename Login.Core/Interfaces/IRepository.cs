...
namespace Login.Core.Interfaces
{
    public interface IRepository
    {
        ...
        PagedResult<T> List<T>(string[] navProperties, Expression<Func<T, Object>> predicateSort, EnumOrder typeOrder, int page, int limit) where T : BaseEntity;

        PagedResult<T> List<T>(Expression<Func<T, Object>> predicateSort, EnumOrder typeOrder, int page, int limit) where T : BaseEntity;
        ...
        PagedResult<T> Filter<T>(Expression<Func<T, bool>> predicate, string[] navProperties, Expression<Func<T, Object>> predicateSort, EnumOrder typeOrder, int page, int limit) where T : BaseEntity;

        PagedResult<T> Filter<T>(Expression<Func<T, bool>> predicate, Expression<Func<T, Object>> predicateSort, EnumOrder typeOrder, int page, int limit) where T : BaseEntity;
